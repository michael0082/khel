...
const projectDetail = [{
  title: 'Tonic',
  exprience: ['CANOPY', 'Back End Dev', '2024'],
  desription: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
  popDescription: 'A short burst of inconsequential information and chirps from birds, which describes the purpose of social networking on Twitter.',
  technologies: ['html', 'css', 'javascript'],
  popupTech: ['html', 'css', 'javaScript', 'github', 'Ruby', 'Bootstrap'],
  images: 'images/t.png',
  imagesMobile: 'images/t.png',
  imagesPopup: 'images/t.png',
  imagesMobilePopup: 'images/t.png',
  seeLive: 'https://github.com/michael0082',
  seeSource: 'https://github.com/michael0082',
},
{
  title: 'Facebook ',
  exprience: ['FACEBOOK', 'Back End Dev', '2024'],
  ...
  popDescription: 'A website which allows users, who sign-up for free profiles, to connect with friends, work colleagues or people they',
  technologies: ['html', 'Ruby on rails', 'css', 'javascript'],
  popupTech: ['html', 'css', 'javaScript', 'github', 'Ruby', 'Bootstrap'],
  images: 'images/fa.png',
  imagesMobile: 'images/fa.png',
  imagesPopup: 'images/fa.png',
  imagesMobilePopup: 'images/fa.png',
  seeLive: 'https://www.facebook.com/people/Michael-Cabalida/pfbid0nBKfamBvdCJqj5p8ji3Vcqj8idXgD9UT5P1Gi6NzvAnKh7SivHwcqM8WC2df4ni1l/',
  seeSource: 'https://github.com/michael0082',
},
];
for (let i = 0; i < projectDetail.length; i += 1) {
  ...
  <div class="grid-item" id="work-1">
    <div class="flex-item1"><img src="${projectDetail[i].imagesMobile}" alt="my cabalida project"></div>
    <div class="desk-item1"><img src="${projectDetail[i].images}" alt="my cabalida project"></div>
    <div class="desk-col">
...
const displayPopupModal = (i) => {
  ...
  <div class="works-flex">
      ...
      <div class="works-flex-item work-image">
          <img src="${projectDetail[i].imagesMobilePopup}" class="flex-item1" alt="${projectDetail[i].title} project screenshot"/>
          <img src="${projectDetail[i].imagesPopup}" class="desk-item1" alt="${projectDetail[i].title} project screenshot"/>
      </div>
